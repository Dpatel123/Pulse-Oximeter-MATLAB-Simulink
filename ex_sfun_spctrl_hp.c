 ...
 *
 *         double y1 = pofilt(int32 u1, double u2)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 04-Feb-2021 17:11:39
 *
...
/**
     ...
     def.OutputFcnSpec = 'double y1 = pofilt(int32 u1, double u2)';
     def.HeaderFiles = {'pofilt.h'};
     def.SourceFiles = {'pofilt_hplp.c'};
...
#define S_FUNCTION_NAME  ex_sfun_spctrl_hp
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "pofilt", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
