 ...
 *
 *         double y1 = pofilt_lp(int32 u1, double u2)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 24-Jan-2021 02:43:55
 *
...
#define S_FUNCTION_NAME  ex_sfun_spctrl_lp
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "pofilt_lp", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
